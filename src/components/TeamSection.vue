<template>
  <section id="team" class="bg-white py-28">
...
const bgs = [
  'background: linear-gradient(160deg, #0B1C3E, #1A3160)',
  'background: linear-gradient(160deg, #A81E1E, #0B1C3E)',
  'background: linear-gradient(160deg, #122448, #0B1C3E)',
  'background: linear-gradient(160deg, #D42B2B, #0B1C3E)',
]
</script>
